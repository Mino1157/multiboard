...
public class BoardController {
    ...
    public String getBoardDetails(@PathVariable int boardId,
    ...
    public String writeForm(@PathVariable int categoryId,
                            HttpSession session, Model model) {
    ...
    public String replyForm(@PathVariable int boardId, Model model) {
    ...
    public String search(@RequestParam(required=false, defaultValue="") String 
    keyword, @PathVariable int page, HttpSession session, Model model) {
    try {
